...
var Operators =
{
   oActMap :{},
    ...
    {
        var aNewBtns = [],
            oSupportBtn = {"detail": true, "delete": true, "edit": true,"reboot":true,"download":true,"upgrade":true,"import":true,"custom":true};
...
Frame.SimpleList = function (_jSlist)
{
    ...
    function createSearch(bFlag, jTable)
    {
        ...
        for(var i=0;i<aColDef.length;i++)
        {
            ...
            if(aColDef[i].id == "slist_operation")
            {
                continue;
            }
    ...
    function createDefButtons(opt, jTable)
    {
        ...
        var aDefBtn = [
                ...
                {id:"slist_download",   no:999, name:"download",    value:$.MyLocale.Buttons.DOWNLOAD, enable:false, icon:"slist-download",   Show:true},
                ...
                {id:"slist_custom",    no:999, name:"custom",     value:$.MyLocale.Buttons.CUSTOM,      enable:true, icon:"slist-custom",   Show:true},
            ];

        var aButton = Operators.mergeButton(aDefBtn, opt.buttons);
        var jBtnBar = $('<div class="slist-toolbar-top"></div>').appendTo(jTable);
        var oSupportBtn = {"detail": true, "delete": true, "edit": true,"reboot":true,"download":true,"upgrade":true,"import":true,"custom":true};
    ...
    function appendRows(aData, jTable)
    {
        ...
        if(!aData.length)
        {
            ...
            $('.page-num',jPageBar).val(0);
            $('.page-total',jPageBar).text(0);
            return false;
        }
