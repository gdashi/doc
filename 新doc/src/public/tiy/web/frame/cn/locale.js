$.MyLocale_cn = {
    ...
    Menu:{
        ...
        ,W_Form: "Form"
        ,W_Minput: "Minput"
        ,W_SingleSelect: "SingleSelect"
        ,W_UtilBase: "UtilBase"
        ,W_DateTime:"DateTime"
        ,W_DateRange:"DateRange"
        ,W_Switch:"Switch"
        ,W_EditTable:"EditTable"
        ,W_EditList:"EditList"
        ,W_FullCalender:"FullCalender"
        ,W_Mjs:"Mjs"
        ,M_System:"概览"
        ,M_Dashboard:"设备概览"
        ,M_ClientInfor:"终端信息"
       ...
       // ,M_Cooperation:"合作应用"
        ...
        ,P_Cusdpi:"客流探针"
        ,P_CuAnalysis:"宾客行为分析"
        ,P_Wirelesslocation:"无线定位"
        ,P_Configrestore:"配置还原"
        ,P_Softupdate:"软件升级"
        ,P_Filesystem:"文件系统"
        ,P_Command:"命令助手"
        ,P_Opdevice:"设备操作"
        ...
        ,City_LogWaring:"告警日志"
        ,City_Dashboard:"设备概览"
        ,City_DeviceOper:"设备操作"
        ,City_TerminalInfo:"终端信息"
        ,City_AssoAnalysis:"关联分析"
        ,City_Location:"城区划分"
        ,City_WirelessTerminal:"无线终端"
        ,City_WirelessSecurity:"无线安全"
        ,City_ReconnectCloudPipe:"重连云管道"
        ,City_MonConfig:"安全策略"
		,City_WirelessCfg:"无线配置"
