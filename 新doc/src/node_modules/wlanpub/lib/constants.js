...
module.exports = cons = {
    ...
    "serviceName" : Object.freeze({
        ...
        "msgnotifyserver"         : "msgnotifyserver",         // 短信通知微服务
        "subscribemgr"            : "subscribemgr",            // 告警订阅管理
        "msgpushserver"           : "msgpushserver",           // IOS设备消息推送
    ...
    "production_mqhost": ["172.16.4.147"],
    "scedefaultMongoParas": "mongodb://scenarios:scenarios@172.27.8.106:27017/scenarios",
    "sceproductMongoParas": "mongodb://scenarios:scenarios@172.16.4.147:27017/scenarios",
    "v3testMongoParas" : "mongodb://v3test-Mongodb:27017/scenarios"
};
