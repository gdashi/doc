...
// 该函数用于判断指定的设备是否绑定到指定的用户,仅限webserver使用，不适合其它微服务使用
exports.isDevBind2UserForWebserver = function(cookies, session, devSN, callback) {
    //如果是rd账户登录,可查看所有设备
...
// 该函数用于判断指定的设备是否绑定到指定的用户,仅限微服务使用，不适合webserver使用
